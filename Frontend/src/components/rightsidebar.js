...
function Rightsidebar() {
    return (
        <div className='bg-white min-h-screen w-96 drop-shadow-xl rounded-l-xl ml-auto fixed right-1'>
            ...
            {/* menu bar */}
            <div className='overflow-y-auto' style={{ maxHeight: '333px', overflowY: 'auto' }}>
            ...
            <div className='flex w-full justify-center'>
                <div className='sm:mx-auto sm:w-[83%]'>
                    <div className='border-2 border-gray-100 bg-gray-100 rounded-lg mt-9 overflow-hidden relative'>
                        <div className='flex ml-4 mt-2'>
                            <h5 className='text-slate-600 font-semibold mb-2'>Sub Total</h5>
                            <h5 className='ml-36 text-sm'>IDR 0.000</h5>
                        </div>
                        <hr className='ml-2 mr-3 border-gray-400' />
                        <div className='flex ml-4 mt-1 mb-1'>
